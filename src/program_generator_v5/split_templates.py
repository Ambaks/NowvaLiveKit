...
_UPPER_B = SessionTemplate(
    ...
    required_movement_patterns=[
        MP.VERTICAL_PUSH, MP.HORIZONTAL_PULL, MP.VERTICAL_PULL,
        MP.ISOLATION_PUSH, MP.ISOLATION_PULL,
    ],
    optional_movement_patterns=[MP.HORIZONTAL_PUSH],
    max_exercises=7,
    max_duration_minutes=60,
    is_primary=True,
)
...
_STRENGTH_UPPER = SessionTemplate(
    ...
    required_movement_patterns=[
        MP.HORIZONTAL_PUSH, MP.VERTICAL_PULL,
    ],
    optional_movement_patterns=[
        MP.HORIZONTAL_PULL, MP.VERTICAL_PUSH,
        MP.ISOLATION_PUSH, MP.ISOLATION_PULL,
    ],
    max_exercises=6,
    max_duration_minutes=60,
...
_STRENGTH_LOWER = SessionTemplate(
    ...
    muscle_groups=[
        MG.QUADS, MG.HAMSTRINGS, MG.GLUTES, MG.CALVES, MG.ABS,
    ],
    required_movement_patterns=[MP.SQUAT, MP.HIP_HINGE],
    optional_movement_patterns=[MP.LUNGE, MP.CORE],
    max_exercises=6,
