...
def _resolve_function(module, function_name: str) -> Callable:
    """Resolve a string function name to a callable on the given module."""
...
def _validate_cross_references(
    ...
    """Verify all cause_ids referenced in symptoms exist in causes."""
...
# Module-level initialization — fail fast if graph is malformed
