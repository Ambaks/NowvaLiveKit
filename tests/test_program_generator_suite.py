...
Run with: python -m program_generator.test_suite
Or:       cd src/program_generator && python test_suite.py
"""
...
# Add program_generator to path for bare imports (schemas, etc.)
